...
String getBunnyVideoURL(VideoItemStruct videoItem) {
  String url = 'https://iframe.mediadelivery.net/play';

  print('Making URL $url/${videoItem.videoLibraryId}/${videoItem.guid}');
