...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: TvShowsDetailsWidget.routeName,
          path: TvShowsDetailsWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => EpisodesWidget(
            ...
            seasonNum: params.getParam(
              'seasonNum',
              ParamType.int,
            ),
            seasonName: params.getParam(
              'seasonName',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: BookarkWidget.routeName,
          path: BookarkWidget.routePath,
        ...
        FFRoute(
          ...
          path: MoviesViewWidget.routePath,
          builder: (context, params) => MoviesViewWidget(),
        ),
        FFRoute(
          name: MovieDetailViewWidget.routeName,
          path: MovieDetailViewWidget.routePath,
          builder: (context, params) => MovieDetailViewWidget(
            seriesData: params.getParam<SeriesRow>(
              'seriesData',
              ParamType.SupabaseRow,
            ),
            videoData: params.getParam(
              'videoData',
              ParamType.DataStruct,
              isList: false,
              structBuilder: VideoItemStruct.fromSerializableMap,
            ),
          ),
        ),
        FFRoute(
          name: SeriesTitleViewWidget.routeName,
          path: SeriesTitleViewWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'SeriesTitleView')
              : SeriesTitleViewWidget(),
        ),
        FFRoute(
